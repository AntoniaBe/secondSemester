...
//Prints out the current booking for the customer, with all the required informations.
	...
	public void showBooking()
	{
		...
		System.out.println("#####################################");
		System.out.println();
		System.out.println(this.movie.getName() + "- " + this.movie.getMovieTime());
		System.out.println("Total seats : " + this.seats.size());
		System.out.println(("Total price :" + this.movie.getPrice() * this.seats.size() ) + "€");
...
//Removes all the current reserved seats and makes them "FREE" again.	
...
//Method for showing the movie list, checking the entered movie number and getting the theaters for each movie.
//Prints out the seating plan for a selected theater. 
//Selecting n seats with its row and column. Every seat will be saved to the ArrayList seats.
...
//Checks the entered row. Neither a negative number nor a number above four is allowed.
...
//Checks the entered column. Neither a negative number nor a number above eight is allowed.	
...
//Shows the complete movie list with the movie title, movie time and price.	
		
	private void showMovieList()
	{
	  for(Movie movie : this.movieList)
	  {
		 System.out.println(movie.getName() + " - " + movie.getMovieTime() +  " - " + movie.getPrice() + "€" );
	   }
	 }
