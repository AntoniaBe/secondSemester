...
// Adds some movies to the ArrayList movieList
...
// Creates a new customer or compares the entered user name with the existing entries. 
//If the customer account doesn't exist yet, the new customer will be added to the ArrayList customers.
...
//Mainmethod. Creates customer, shows a movieplan and creates the different theaters. 
//Saves the name of the movie and number of seats for a current booking.
//Prints out a ticket for the customer.
