        ...
        else if (singleChar == ')') 
        {
          ...
          while (!(charOnStack.equals('(')) && !(stack.isEmpty()))
          {
            ...
            else if (singleChar == '+' || singleChar == '-') 
           {
             ...
             {
               Character charOnStack = stack.top().toChar();
               while (!(stack.isEmpty() || charOnStack.equals(new Character('(')) 
            ...
            else if (singleChar == '*' || singleChar == '/') 
            {
             ...
             else 
             {
               ...
               && !charOnStack.equals(new Character('-')) && !stack.isEmpty()) {
               stack.pop();
                postfixString += charOnStack.charValue();
              }
               stack.push(singleChar);
            ...
            else if (singleChar == '^')
            {
              ...
              {
               Character charOnStack = stack.top().toChar();
               while (!charOnStack.equals(new Character('+')) && !charOnStack.equals(new Character('-')) 
                && !charOnStack.equals(new Character('*')) && !charOnStack.equals(new Character('/')) 
               && !stack.isEmpty()) 
               {
                stack.pop();
                postfixString += charOnStack.charValue();
